...
async def start(client: Client, msg: Message):
    ...
    await start_message.edit_text(
        Data.START.format(msg.from_user.mention) +
        "Checking status Ok... Command Nhi Bataunga   Bot Made BY 𓆩ᵢ𝚗fᵢ𝚗ᵢ𝚝y𓆪\n\n"
        "Progress:[🟩🟩🟩🟩🟩🟩🟩🟩🟩] 100%\n\n"
    )
...
async def txt_handler(bot: Client, m: Message):
    ...
    editable = await m.reply_text(f"**🔹Hi I am Poweful TXT Downloader📥 Bot.**\n🔹**Send me the TXT file and waiting.**")
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            try:  
                ...
                cc = f'🎞️ 𝑽𝑰𝑫_𝑰𝑫 **- {str(count).zfill(3)}**\n\n🗒 𝐓𝐢𝐭𝐥𝐞 **- {name1}** 🅒𝚘𝚞𝚛𝚜𝚎🅒𝚘𝚛𝚗𝚎𝚛 {res}.mkv\n\n📚 𝐁𝐚𝐭𝐜𝐡 **- {b_name}**\n\n📥  𝑬𝒙𝒕𝒓𝒂𝒄𝒕 𝑩𝒚 **-** {CR}\n\n━━━━━𓆩ᵢ𝚗fᵢ𝚗ᵢ𝚝y𓆪━━━━━'
                cc1 = f'📁 𝑽𝑰𝑫_𝑰𝑫 **- {str(count).zfill(3)}**\n\n🗒 𝐓𝐢𝐭𝐥𝐞 **- {name1}** 🅒𝚘𝚞𝚛𝚜𝚎🅒𝚘𝚛𝚗𝚎𝚛.pdf\n\n📚 𝐁𝐚𝐭𝐜𝐡 **- {b_name}**\n\n📥  𝑬𝒙𝒕𝒓𝒂𝒄𝒕 𝑩𝒚 **-** {CR}\n\n━━━━━𓆩ᵢ𝚗fᵢ𝚗ᵢ𝚝y𓆪━━━━━'
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            try:  
                ...
                cc = f'**🎞️ VID_ID: {str(count).zfill(3)}.\n\n Title: {name1} 🅒𝚘𝚞𝚛𝚜𝚎🅒𝚘𝚛𝚗𝚎𝚛 {res}.mkv\n\n📚 Batch Name: {b_name}\n\n📥 Extracted By : {CR}\n\n━━━━━𓆩ᵢ𝚗fᵢ𝚗ᵢ𝚝y𓆪━━━━━'
                cc1 = f'**📁 PDF_ID: {str(count).zfill(3)}.\n\n Title: {name1} 🅒𝚘𝚞𝚛𝚜𝚎🅒𝚘𝚛𝚗𝚎𝚛.pdf\n\n📚 Batch Name: {b_name}\n\n📥 Extracted By : {CR}\n\n━━━━━𓆩ᵢ𝚗𝘧ᵢ𝚗ᵢ𝚝𝘺𓆪━━━━━'
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            try:  
                ...
                cc = f'🎞️ 𝑽𝑰𝑫_𝑰𝑫 **- {str(count).zfill(3)}**\n\n🗒 𝐓𝐢𝐭𝐥𝐞 **- {name1}** 🅒𝚘𝚞𝚛𝚜𝚎🅒𝚘𝚛𝚗𝚎𝚛 {res}.mkv\n\n<pre><code>📚 𝐁𝐚𝐭𝐜𝐡 **- {b_name}**</code></pre>\n\n📥  𝑬𝒙𝒕𝒓𝒂𝒄𝒕 𝑩𝒚 **-** {CR}\n\n━━━━━𓆩ᵢ𝚗𝘧ᵢ𝚗ᵢ𝚝𝘺𓆪━━━━━'
                cc1 = f'📁 𝑷𝑫𝑭_𝑰𝑫 **- {str(count).zfill(3)}**\n\n🗒 𝐓𝐢𝐭𝐥𝐞 **- {name1}** 🅒𝚘𝚞𝚛𝚜𝚎🅒𝚘𝚛𝚗𝚎𝚛.pdf\n\n<pre><code>📚 𝐁𝐚𝐭𝐜𝐡 **- {b_name}**</code></pre>\n\n📥  𝑬𝒙𝒕𝒓𝒂𝒄𝒕 𝑩𝒚 **-** {CR}\n\n━━━━━𓆩ᵢ𝚗𝘧ᵢ𝚗ᵢ𝚝𝘺𓆪━━━━━'
